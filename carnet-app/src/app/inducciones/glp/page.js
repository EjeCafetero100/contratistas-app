...
// Catálogo de preguntas oficial para GLP (Gas Licuado de Petróleo)
export const EVALUATION_QUESTIONS = [
  {
    "id": "normas_seguridad",
    "num": 1,
    "bloque": "Seguridad Operativa",
    "bloqueColor": "#00205b",
    "title": "1. Seleccione la respuesta correcta con respecto a las normas de seguridad del cd",
  ...
  },
  {
    ...
    "bloqueColor": "#3b82f6",
    "title": "2. El limite de velocidad dentro del cd es",
    "shortTitle": "P2. Límite Velocidad",
    "expectedAnswer": "10 Km/h",
    "icono": "⚡"
  },
  {
    "id": "riesgo_glp",
    ...
    "bloque": "Riesgos GLP",
    "bloqueColor": "#ef4444",
    "title": "3. Cuá es el principal riesgo asociado a glp",
    "shortTitle": "P3. Riesgo GLP",
    "expectedAnswer": "Incendio o explosión por fuga del gas",
    "icono": "🔥"
  },
  {
    "id": "olor_gas",
    ...
    "bloque": "Riesgos GLP",
    "bloqueColor": "#ef4444",
    "title": "4. ¿Si durante el ingreso al cd detecta olor a gas en su vehículo, que debe hacer?",
    "shortTitle": "P4. Olor a Gas",
    "expectedAnswer": "Apagar el vehículo y reportar inmediatamente la novedad",
    "icono": "⚠️"
  },
  {
    "id": "bloqueo_glp",
    "num": 5,
    "bloque": "Operación & Descargue",
    "bloqueColor": "#00205b",
    "title": "5. Cual es el proceso de bloqueo del vehículo de glp en el área de descargue de cilindros",
    "shortTitle": "P5. Bloqueo GLP",
    "expectedAnswer": "Debo poner tacos y realizar el respectivo control de llaves",
    "icono": "🔒"
  },
  {
    "id": "punto_encuentro",
...
export default function InduccionGlpDashboard() {
  ...
  const [formData, setFormData] = useState({
    ...
    "limite_velocidad": "10 Km/h",
    "riesgo_glp": "Incendio o explosión por fuga del gas",
    "olor_gas": "Apagar el vehículo y reportar inmediatamente la novedad",
    "bloqueo_glp": "Debo poner tacos y realizar el respectivo control de llaves",
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const res = await fetch("/api/inducciones/glp");
  ...
  const handleExportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "Respuestas GLP (Gas Licuado de Petróleo)");
    XLSX.writeFile(wb, "Induccion_GLP_Evaluaciones_Barrancabermeja.xlsx");
  };
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc", padding: "1.5rem" }}>
      <div style={{ maxWidth: 1440, margin: "0 auto" }}>
        ...
        {/* Hero Banner */}
        <div style={{
          background: "linear-gradient(135deg, #00205b 0%, #1e1b4b 100%)",
          borderRadius: 20,
          ...
          <div style={{ maxWidth: 850, position: "relative", zIndex: 1 }}>
            ...
            <h1 style={{ fontSize: "1.85rem", fontWeight: 900, margin: "0 0 0.5rem 0", letterSpacing: "-0.5px" }}>
              Dashboard Estadístico: Inducción de GLP (Gas Licuado de Petróleo)
            </h1>
            <p style={{ margin: 0, fontSize: "0.95rem", color: "#cbd5e1", lineHeight: 1.5 }}>
              Supervisión analítica de conductores y personal de GLP en protocolos de descargue, bloqueo de vehículos, prevención de fugas y evacuación en CD.
            </p>
          </div>
        </div>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "1rem", marginBottom: "1.25rem" }}>
                <div>
                  ...
                  <p style={{ margin: "0.3rem 0 0 0", fontSize: "0.85rem", color: "#64748b" }}>
                    Porcentaje de acierto de los evaluados en cada una de las 12 preguntas de inducción de GLP (Gas Licuado de Petróleo).
                  </p>
                </div>
              </div>
          ...
          <div style={{ position: "fixed", inset: 0, background: "rgba(0, 32, 91, 0.6)", backdropFilter: "blur(4px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999, padding: "1.5rem" }}>
            <div style={{ background: "#ffffff", borderRadius: 20, width: "100%", maxWidth: 720, maxHeight: "90vh", overflowY: "auto", padding: "2rem" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.25rem" }}>
                <div>
                  <h3 style={{ fontSize: "1.3rem", fontWeight: 900, color: "#00205b", margin: 0 }}>Registrar Inducción de GLP (Gas Licuado de Petróleo)</h3>
