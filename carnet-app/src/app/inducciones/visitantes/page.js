...
// Catálogo de preguntas oficial para Visitantes
export const EVALUATION_QUESTIONS = [
  {
    "id": "normas_cd",
    "num": 1,
    "bloque": "Protocolo de Ingreso",
    "bloqueColor": "#00205b",
    "title": "1. Seleccione la respuesta correcta con respecto a las normas del cd",
    "shortTitle": "P1. Normas CD",
  ...
  },
  {
    ...
    "bloque": "Protocolo de Ingreso",
    "bloqueColor": "#00205b",
    "title": "2. Para ingresar al cd debo tener un permiso de ingreso, haber presentado seguridad social y afiliaciones",
    "shortTitle": "P2. Permiso Ingreso",
  ...
  },
  {
    ...
    "bloqueColor": "#3b82f6",
    "title": "3. El limite de velocidad en el Cd es",
    "shortTitle": "P3. Límite Velocidad",
    "expectedAnswer": "10 Km/hr",
    "icono": "⚡"
  },
  {
    "id": "parqueadero_particular",
    "num": 4,
    "bloque": "Control Vehicular",
    "bloqueColor": "#10b981",
    "title": "4. Para ingresar al parqueadero de vehículos particulares es necesario contar con la documentación al día",
    "shortTitle": "P4. Parqueadero Particular",
    "expectedAnswer": "Verdadero",
    "icono": "🚗"
  },
  {
    "id": "areas_operativas",
    "num": 5,
    "bloque": "Restricción de Áreas",
    "bloqueColor": "#ef4444",
    "title": "5. Si realiza trabajos administrativos, esta permitido ingresar a las áreas operativas, patio de maniobra, parqueaderos de T2, área de almacenamiento de producto",
    "shortTitle": "P5. Áreas Operativas",
  ...
  },
  {
    ...
    "bloqueColor": "#f59e0b",
    "title": "6. El punto de encuentro queda en el área externa del cd",
    "shortTitle": "P6. Punto Encuentro",
    "expectedAnswer": "Verdadero",
    "icono": "📍"
  },
  {
    ...
    "bloque": "Evacuación & Emergencias",
    "bloqueColor": "#f59e0b",
    "title": "7. A partir de qué señal sonora del sistema de alarma se debe iniciar el proceso de evacuación hacia el punto de encuentro",
    "shortTitle": "P7. Alarma Sonora",
  ...
  },
  {
    ...
    "bloque": "Evacuación & Emergencias",
    "bloqueColor": "#f59e0b",
    "title": "8. En caso de evacuación en el punto de encuentro se debe ubicar con el personal de su contratista y así facilitar el conteo",
    "shortTitle": "P8. Conteo Contratistas",
  ...
  },
  {
    ...
    "bloque": "Evacuación & Emergencias",
    "bloqueColor": "#f59e0b",
    "title": "9. Los brigadistas se identifican con una insignia en el casco",
    "shortTitle": "P9. Brigadistas",
    "expectedAnswer": "Verdadero",
    "icono": "👷"
  },
  {
    ...
    "bloque": "Evacuación & Emergencias",
    "bloqueColor": "#f59e0b",
    "title": "10. La señalización verde con flechas que me indican",
    "shortTitle": "P10. Señal Verde",
  ...
  },
  {
    ...
    "bloqueColor": "#8b5cf6",
    "title": "11. La información suministrada fue clara",
    "shortTitle": "P11. Claridad Info",
    "expectedAnswer": "Si",
    "icono": "💡"
  },
  {
    ...
    "bloque": "Compromiso & Percepción",
    "bloqueColor": "#8b5cf6",
    "title": "12. Las normas de seguridad protegen mi vida y la de otros funcionarios dentro del cd",
    "shortTitle": "P12. Protege la Vida",
    "expectedAnswer": "Si",
    "icono": "❤️"
  }
];
...
export default function InduccionVisitantesDashboard() {
  ...
  const [formData, setFormData] = useState({
    ...
    "normas_cd": "Todas las anteriores",
    "permiso_ingreso": "Verdadero",
    "limite_velocidad": "10 Km/hr",
    "parqueadero_particular": "Verdadero",
    "areas_operativas": "Falso",
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const res = await fetch("/api/inducciones/visitantes");
  ...
  }, [data.records, search, filterEmpresa ]);
  ...
  const handleExportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "Respuestas Visitantes");
    XLSX.writeFile(wb, "Induccion_Visitantes_Evaluaciones_Barrancabermeja.xlsx");
  };
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc", padding: "1.5rem" }}>
      <div style={{ maxWidth: 1440, margin: "0 auto" }}>
        ...
        {/* Hero Banner */}
        <div style={{
          background: "linear-gradient(135deg, #00205b 0%, #0369a1 100%)",
          borderRadius: 20,
          ...
          <div style={{ maxWidth: 850, position: "relative", zIndex: 1 }}>
            ...
            <h1 style={{ fontSize: "1.85rem", fontWeight: 900, margin: "0 0 0.5rem 0", letterSpacing: "-0.5px" }}>
              Dashboard Estadístico: Inducción de Visitantes
            </h1>
            <p style={{ margin: 0, fontSize: "0.95rem", color: "#cbd5e1", lineHeight: 1.5 }}>
              Control visual de inducciones para visitantes comerciales y administrativos (normas de acceso, límites de velocidad, zonas permitidas y plan de evacuación).
            </p>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: "2.35rem", fontWeight: 900, color: "#3b82f6" }}>
              100%
            </div>
            <div style={{ fontSize: "0.8rem", color: "#64748b", marginTop: "0.25rem" }}>
              EPS, ARL y Seguridad Social validada
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          >
            <span>🔍</span> GRÁFICA POR PREGUNTA (P1-P12)
          </button>
                ...
                <div>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                    ...
                    <h3 style={{ fontSize: "1.2rem", fontWeight: 800, color: "#00205b", margin: 0 }}>
                      Gráfica de Acierto por Pregunta (12 Preguntas Oficiales)
                    </h3>
                  </div>
                  <p style={{ margin: "0.3rem 0 0 0", fontSize: "0.85rem", color: "#64748b" }}>
                    Porcentaje de acierto de los evaluados en cada una de las 12 preguntas de inducción de Visitantes.
                  </p>
                </div>
              </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(420px, 1fr))", gap: "1.5rem" }}>
              ...
              <div style={{ background: "#ffffff", borderRadius: 18, padding: "1.75rem", border: "1px solid #e2e8f0", boxShadow: "0 4px 15px rgba(0, 32, 91, 0.04)" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.25rem" }}>
                  ...
                  <h3 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#00205b", margin: 0 }}>
                    Seguridad Social & Acceso Autorizado
                  </h3>
                </div>
                <p style={{ margin: "0 0 1rem 0", fontSize: "0.82rem", color: "#64748b" }}>
                  Control de ingreso conforme a protocolo del CD.
                </p>
                <div style={{ padding: "1.5rem", background: "#f0fdf4", borderRadius: 14, border: "1px solid #bbf7d0", marginTop: "1rem" }}>
                  <div style={{ fontSize: "1.1rem", fontWeight: 800, color: "#166534", marginBottom: "0.5rem" }}>
                    ✓ 100% Cobertura Validada
                  </div>
                  <p style={{ margin: 0, fontSize: "0.88rem", color: "#15803d", lineHeight: 1.5 }}>
                    Todos los visitantes registrados cuentan con registro de afiliación a EPS, ARL y contactos de emergencia verificados antes de ingresar al CD.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem", marginBottom: "1.25rem" }}>
              <div>
                ...
                <p style={{ margin: "0.2rem 0 0 0", fontSize: "0.85rem", color: "#64748b" }}>
                  Haz clic en cualquier tarjeta o botón para desplegar las 12 preguntas de esa persona.
                </p>
              </div>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "1.25rem" }}>
                          <div style={{ minWidth: 140, textAlign: "right" }}>
                            ...
                            <div style={{ fontSize: "1.25rem", fontWeight: 900, color: r.aprobado ? "#10b981" : "#ef4444" }}>
                              {porcentajeAcierto}% ({aciertosPersona}/12)
                            </div>
                        ...
                        <div style={{ padding: "1.5rem", background: "#fbfcfe" }}>
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem", paddingBottom: "0.75rem", borderBottom: "1px solid #e2e8f0" }}>
                            <h4 style={{ fontSize: "0.95rem", fontWeight: 800, color: "#00205b", margin: 0 }}>
                              Respuestas completas de {r.nombre_completo} (12 preguntas):
                            </h4>
          ...
          <div style={{ background: "#ffffff", borderRadius: 16, border: "1px solid #e2e8f0", boxShadow: "0 4px 15px rgba(0, 32, 91, 0.04)", overflow: "hidden" }}>
            <div style={{ overflowX: "auto" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left", fontSize: "0.9rem" }}>
                ...
                <tbody>
                  {loading ? (
                    <tr><td colSpan={5} style={{ padding: "3rem", textAlign: "center", color: "#64748b" }}>Cargando registros...</td></tr>
                  ) : filteredRecords.length === 0 ? (
          ...
          <div style={{ position: "fixed", inset: 0, background: "rgba(0, 32, 91, 0.6)", backdropFilter: "blur(4px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999, padding: "1.5rem" }}>
            <div style={{ background: "#ffffff", borderRadius: 20, width: "100%", maxWidth: 720, maxHeight: "90vh", overflowY: "auto", padding: "2rem" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.25rem" }}>
                <div>
                  <h3 style={{ fontSize: "1.3rem", fontWeight: 900, color: "#00205b", margin: 0 }}>Registrar Inducción de Visitantes</h3>
