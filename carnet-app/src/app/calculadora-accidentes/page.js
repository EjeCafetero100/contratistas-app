...
export default function CalculadoraAccidentes() {
  ...
  // Fecha SIF por defecto: 45 días atrás
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '3rem', width: '100%' }}>
        ...
        >
          ...
          <div style={{ 
            fontSize: '9rem', 
            fontWeight: '800', 
            color: '#2dd4bf', // Color cyan para distinguirlo del verde de accidentes
            lineHeight: '1',
            textShadow: '0px 4px 20px rgba(45, 212, 191, 0.4)',
            fontFamily: 'system-ui, -apple-system, sans-serif'
          }}>
            {daysWithoutSif.toFixed(1)}
          </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '3rem', marginTop: '3rem' }}>
        ...
        <div className="glass-panel" style={{ width: '100%', maxWidth: '600px', padding: '2rem', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', marginTop: '2rem' }}>
            <label htmlFor="sif-date" style={{ fontWeight: '600', color: 'var(--text-main)' }}>
            ...
            <input 
              ...
              type="date" 
              value={lastSifDate}
              onChange={(e) => setLastSifDate(e.target.value)}
              style={{ 
                padding: '1rem 1.5rem', 
                fontSize: '1.2rem', 
                borderRadius: '12px', 
